...
const MensPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchMensProducts = async () => {
      try {
        let query = 'http://localhost:5000/api/products?category=women&subCategory=t-shirt';
  ...
  return (
    ...
    <h3 className="text-2xl font-semibold mb-2  text-center text-white">Womens Products</h3>
